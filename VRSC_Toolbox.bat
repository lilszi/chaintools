...
ECHO       VRSC: RCsdERNGwQA11diYpAFhvXwfwvmszQyrFc
ECHO. 
ECHO .....................................................
...
komodo-cli -ac_name=VRSC setgenerate true
ECHO.
...
CLS
cd resources\app\assets\bin\win64\
komodo-cli.exe -ac_name=VRSC setgenerate false
ECHO.
...
CLS
cd resources\app\assets\bin\win64\
komodo-cli -ac_name=VRSC getmininginfo
ECHO.
TIMEOUT /T 5
GOTO MENU
...
CLS
cd resources\app\assets\bin\win64\
komodo-cli -ac_name=VRSC getbalance
ECHO.
TIMEOUT /T 5
GOTO MENU
